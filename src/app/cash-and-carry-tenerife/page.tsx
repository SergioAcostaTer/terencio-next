    ...
    <main>
      ...
      <Section className="bg-white" id="ventajas">
        <div className="mb-16 text-center">
          <span className="rounded-full bg-green-100 px-4 py-1 text-sm font-bold tracking-widest text-green-700 uppercase">
            Modelo Híbrido
          </span>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="group relative overflow-hidden rounded-[2rem] border border-green-100 bg-green-50 p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
      ...
      <Section className="relative overflow-hidden bg-slate-900 text-white">
        ...
        <div className="relative z-10 mx-auto max-w-5xl">
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-700 bg-slate-800/50 shadow-2xl backdrop-blur-sm">
            <div className="grid grid-cols-3 border-b border-slate-700 bg-slate-800">
              <div className="flex items-center p-6 text-sm font-bold tracking-wider text-slate-400 uppercase">
                Característica
              </div>
              <div className="flex items-center justify-center gap-2 border-x border-slate-700 bg-green-900/20 p-6 text-center text-lg font-bold text-green-400 md:text-xl">
            ...
            <div className="divide-y divide-slate-700">
              <div className="grid grid-cols-3 transition hover:bg-slate-700/30">
                <div className="p-6 font-medium">Precio</div>
                <div className="border-x border-slate-700 bg-green-900/10 p-6 text-center font-bold text-white">
                  Mayorista
                </div>
              ...
              <div className="grid grid-cols-3 transition hover:bg-slate-700/30">
                <div className="p-6 font-medium">Acceso</div>
                <div className="border-x border-slate-700 bg-green-900/10 p-6 text-center font-bold text-white">
                  Libre (Sin Carnet)
                </div>
                <div className="p-6 text-center text-slate-400">
              ...
              <div className="grid grid-cols-3 transition hover:bg-slate-700/30">
                <div className="p-6 font-medium">Domingos</div>
                <div className="border-x border-slate-700 bg-green-900/10 p-6 text-center font-bold text-white">
                  ABIERTO
                </div>
                <div className="p-6 text-center text-slate-400">Cerrado</div>
              </div>
              <div className="grid grid-cols-3 transition hover:bg-slate-700/30">
                <div className="p-6 font-medium">Carne Fresca</div>
                <div className="border-x border-slate-700 bg-green-900/10 p-6 text-center font-bold text-white">
                  Despiece Propio
                </div>
                <div className="p-6 text-center text-slate-400">
      ...
      <Section className="bg-white text-center">
        ...
        <div className="mx-auto mb-10 h-[450px] max-w-6xl overflow-hidden rounded-[2rem] border-4 border-white shadow-2xl transition duration-500 hover:scale-[1.01]">
        ...
        <div className="flex flex-col justify-center gap-4 sm:flex-row">
          <Button
            ...
            target="_blank"
            variant="primary"
            className="gap-2 px-8 py-4 text-lg font-bold shadow-xl transition-all hover:-translate-y-1"
          >
